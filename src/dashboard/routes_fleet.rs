...
use crate::{deploy, fleet, metrics, search_manager};
...
pub(super) async fn handler_fleet_deploy(
...
pub(super) async fn handler_fleet_deploy_stop(
    State(state): State<Arc<AppState>>,
...
pub(super) async fn handler_fleet_deploy_pause(
    State(state): State<Arc<AppState>>,
    AxumPath(id): AxumPath<u64>,
) -> impl IntoResponse {
    let deployment = {
...
pub(super) async fn handler_fleet_deploy_resume(
    State(state): State<Arc<AppState>>,
    AxumPath(id): AxumPath<u64>,
) -> impl IntoResponse {
    let deployment = {
...
pub(super) async fn handler_fleet_deployments(
    State(state): State<Arc<AppState>>,
) -> impl IntoResponse {
