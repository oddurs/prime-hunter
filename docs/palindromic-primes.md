...
Heuristically, the count of palindromic primes up to N grows as roughly sqrt(N) / log(N), because there are ~sqrt(N) palindromes up to N and each has ~1/log(N) probability of being prime.

## Largest known palindromic prime

As of August 2024, the record is held by **Ryan Propper and Serge Batalov**:

> 10^2,718,281 - 5 * 10^1,631,138 - 5 * 10^1,087,142 - 1
...
- **Repunit primes**: (10^n - 1)/9 = 111...1. All repunit primes are palindromic. Known for n = 2, 19, 23, 317, 1031, 49081, 86453, 109297, 270343, ...
